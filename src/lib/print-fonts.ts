 ...
 *
 * The catalogue is data (`print_fonts` setting, editable in the admin), so a font
 * added there must render with ITS preview stack rather than falling back to the
 * site font just because this file has never heard of it.
 */
